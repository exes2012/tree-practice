...
**До (неправильно):**
```html
<div class="text-[#3B82F6] bg-[#EFF6FF] p-[16px] rounded-[8px] space-y-[12px]">
  <h3 class="text-[18px] font-[600] leading-[24px]">Title</h3>
  <p class="text-[#6B7280] text-[14px]">Description</p>
</div>
```

**После (правильно):**
```html
<div class="text-brand-500 bg-brand-50 p-md rounded-base space-y-sm">
...
.button { @apply px-4 py-2 bg-blue-500 text-white; }
.input { @apply w-full border border-gray-300; }
```
