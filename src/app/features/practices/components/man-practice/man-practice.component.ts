...
export class ManPracticeComponent {
  practices: PracticeCard[] = [
    ...
    { title: 'Подъем МАН через общее поле Шхины', route: '', icon: 'groups', colorClass: 'bg-red-100 dark:bg-red-900', disabled: true, author: 'Гмар Тиккун', tagColorClass: 'bg-red-200 dark:bg-red-800 text-red-800 dark:text-red-200' },
