...
export class CreatorSpacePracticeComponent {
  ...
  practiceSteps = [
    ...
    {
      title: 'Шаг 8: Куб',
      instruction: 'Отметь все пространства одновременно, и себя внутри, формируя куб.',
    },
    {
      title: 'Шаг 9: Вопрос к Творцу',
      instruction: 'Удерживая пространство вниманием найди в этом пространстве Творца"',
    },
    {
  ...
  onPracticeFinished(event: { rating: number }) {
    ...
    this.practiceService.saveLastPractice({
      ...
      route: '/practices/small-state/creator-space',
    });
