...
export class ZeirAnpinSpacePracticeComponent {
  ...
  practiceSteps = [
    { title: 'Шаг 1: Пространство', instruction: 'Почувствуй пространство, себя и свое тело.' },
    {
      ...
      instruction:
        'Отметь пространство сверху. Это сфира Нэцах. Вера в существование Бога. Удерживай это состояние',
    },
    {
      title: 'Шаг 3: Сфира Ход',
      instruction:
        'Отметь пространство снизу. Это сфира Ход. Отказ от идолопоклонства. Удерживай это состояние',
    },
    {
      title: 'Шаг 4: Сфира Есод',
      instruction:
        'Отметь пространство позади себя. Это сфира Есод. Охрана разума от нечистых мыслей. Удерживай это состояние',
    },
    {
      title: 'Шаг 5: Сфира Хесед',
      instruction:
        'Отметь пространство справа от себя. Это сфира Хесэд. Любовь к Богу. Удерживай это состояние',
    },
    {
      title: 'Шаг 6: Сфира Гвура',
      instruction:
        'Отметь пространство слева от себя. Это сфира Гвура. Трепет перед Творцом. Удерживай это состояние',
    },
    {
      title: 'Шаг 7: Сфира Тиферет',
      instruction:
        'Отметь пространство перед тобой. Это сфира Тифэрэт. Вера в единство Бога. Удерживай это состояние',
    },
    {
      title: 'Шаг 8: Куб',
      instruction:
        'Отметь все пространства одновременно, и себя как Малхут внутри них, формируя куб. Удерживай это состояние',
    },
    { title: 'Шаг 9: Найти Творца', instruction: 'Найди в этом пространстве Творца' },
    {
      title: 'Шаг 10: Единение',
      instruction:
  ...
  onPracticeFinished(event: { rating: number }) {
    this.practiceService.saveLastPractice({
      ...
      route: '/practices/small-state/zeir-anpin-space',
    });
