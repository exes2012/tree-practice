...
export class FourStagesPracticeComponent {
  ...
  practiceSteps = [
    {
      ...
      stage: 'Подготовка: Настройка на Свет',
      stageColor: 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200',
    },
    {
    ...
    {
      title: 'Шаг 3. Добавьте стремление',
      instruction:
    ...
    {
      title: 'Шаг 1. Направьте стремление вовне',
      instruction:
    ...
    {
      title: 'Шаг 2. Ощутите ответ света',
      instruction:
    ...
    {
      title: 'Шаг 3. Усильте стремление',
      instruction:
    ...
    {
      title: 'Шаг 1. Измените вектор стремления',
      instruction:
    ...
    {
      title: 'Шаг 3. Раскройте отношение творца',
      instruction:
    ...
    {
      title: 'Шаг 1. Ощутите благодарность',
      instruction:
    ...
    {
      title: 'Шаг 3. Наслаждайтесь отдачей',
      instruction:
    ...
    {
      title: 'Шаг 4. Осознайте парадокс',
      instruction:
    ...
    {
      title: 'Шаг 1. Примите свет «ради него»',
      instruction:
    ...
    },
    {
      ...
      stage: 'Стадия 4: Малхут (מלכות)',
      stageColor: 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200',
    },
    {
      title: 'Шаг 2. Экран (масах) и удар (зивуг де-акаа)',
      instruction:
    ...
    {
      title: 'Оценка',
      instruction: 'Насколько хорошо вы ощущали свет?',
      stage: 'Оценка',
      stageColor: 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200',
    },
  ];
  ...
  onPracticeFinished(event: { rating: number }) {
    this.practiceService.saveLastPractice({
      ...
      route: '/practices/basic/four-stages',
    });
