...
export class KeterTuningPracticeComponent {
  ...
  practiceSteps = [
    ...
    { title: 'Шаг 2.3: Усильте ощущение через «Рывок»', instruction: 'Это главный технический приём для углубления стадии Кэтер. Когда вы чувствуете свет, сделайте осознанный, но аккуратный рывок стремления — короткое, чуть более интенсивное усилие в том же направлении, вовне. Скажите себе мысленно: «Насладись сильнее».' },
  ...
  onPracticeFinished(event: { rating: number }) {
    this.practiceService.saveLastPractice({ name: this.practiceTitle, route: '/practices/basic/keter-tuning' });
