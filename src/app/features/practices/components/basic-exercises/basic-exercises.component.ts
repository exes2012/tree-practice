...
export class BasicExercisesComponent {
  practices: PracticeCard[] = [
    { title: 'Настройка на свет', route: '/practices/runner/keter-tuning', icon: 'wb_sunny', colorClass: 'bg-yellow-100 dark:bg-yellow-900 hover:bg-yellow-200 dark:hover:bg-yellow-800', author: 'Валентин Янишевский', tagColorClass: 'bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200' },
    { title: '4 стадии прямого света', route: '/practices/runner/four-stages', icon: 'auto_awesome', colorClass: 'bg-yellow-100 dark:bg-yellow-900 hover:bg-yellow-200 dark:hover:bg-yellow-800', author: 'Валентин Янишевский', tagColorClass: 'bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200' },
