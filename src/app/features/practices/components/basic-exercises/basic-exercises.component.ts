  ...
  practices: PracticeCard[] = [
    {
      ...
      icon: 'wb_sunny',
      colorClass: 'bg-yellow-100 dark:bg-yellow-900 hover:bg-yellow-200 dark:hover:bg-yellow-800',
      author: 'Валентин Янишевский',
      tagColorClass: 'bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200',
    },
    {
