...
export class ShabbatPracticeComponent {
  ...
  practiceSteps = [
    ...
    },
    {
      title: 'Слово Шабат',
      instruction:
        'Приступим к медитации над словом Шабат: ש ב ת. Как учит нас книга Зоар, слово Шабат – это фактически одно из Имен Бога.',
      stage: 'Имя',
    ...
    },
    {
      title: 'Три буквы',
      instruction:
        'Три буквы слова Шабат: шин, бейт и тав – стоят во главе следующих слов: «мир» Шалом שלום, «благословение» Браха ברכה, «наслаждение» Таануг תענוג.',
      stage: 'Три слова',
