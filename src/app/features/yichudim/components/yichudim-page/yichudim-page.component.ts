...
export class YichudimPageComponent {
  practices: PracticeCard[] = [
    ...
    { title: 'Благодарность', route: '/practices/runner/gratitude-yichud', icon: 'auto_awesome', colorClass: 'bg-purple-100 dark:bg-purple-900 hover:bg-purple-200 dark:hover:bg-purple-800', tagColorClass: 'bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200', author: 'р. Ицхак Гинзбург' },
    { title: 'Любовь (א ה ב ה)', route: '/practices/runner/love-yichud', icon: 'auto_awesome', colorClass: 'bg-purple-100 dark:bg-purple-900 hover:bg-purple-200 dark:hover:bg-purple-800', tagColorClass: 'bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200', author: 'р. Ицхак Гинзбург' },
    { title: 'Шаббат', route: '/practices/runner/shabbat-yichud', icon: 'auto_awesome', colorClass: 'bg-purple-100 dark:bg-purple-900 hover:bg-purple-200 dark:hover:bg-purple-800', tagColorClass: 'bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200', author: 'р. Ицхак Гинзбург' },
    { title: 'Четырехбуквенное имя', route: '/practices/runner/tetragrammaton-yichud', icon: 'auto_awesome', colorClass: 'bg-purple-100 dark:bg-purple-900 hover:bg-purple-200 dark:hover:bg-purple-800', tagColorClass: 'bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200', author: 'р. Ицхак Гинзбург' },
  ];
