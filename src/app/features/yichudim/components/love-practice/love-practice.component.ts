...
export class LovePracticeComponent {
  ...
  practiceSteps = [
    ...
    },
    {
      ...
      instruction:
        'Теперь мысленно представим себе слово ахава: א ה ב ה. Четыре буквы этого слова – алеф, хей, бейт и хей – это первая, пятая, вторая и пятая буквы ивритского алфавита.',
      stage: 'Буквы',
    ...
    },
    {
      ...
      instruction:
        'Сумма их числовых значений – гиматрия – равна 13. Это же число – 13 – есть также числовое значение слова «один», эхад: א ח ד. Почувствуйте связь между любовью и единством.',
      stage: 'Единство',
    ...
    },
    {
      ...
      instruction:
        'Продолжим медитацию над словом ахава. Четыре его буквы составляют аббревиатуру фразы אור הקדוש ברוך הוא «Свет Святого Благословенного» (Ор а-Кадош Барух ху).',
      stage: 'Свет',
