...
const PRACTICES_DEFINITIONS: Practice[] = [
  {
    ...
    startScreenContent: {
      title: 'Выявление установки',
      description:
        'Эта практика поможет вам выявить ограничивающие установки, связанные с вашей целью, и начать работу по их трансформации.',
    },
    steps: [
      {
        id: 'step1',
        title: 'Шаг 1: Формулировка',
        instruction: 'Сформулируй свою цель: "{{goal.title}}".',
        type: 'instruction',
      },
      {
        id: 'step2',
        title: 'Шаг 2: Ощущение',
        instruction: 'Почувствуй пространство, себя, свое тело.',
        type: 'instruction',
      },
      {
        id: 'step3',
        title: 'Шаг 3: Самоотмена',
        instruction: 'Повторяй до состояния уменьшения важности и самоотмены:',
        type: 'instruction',
        repeatablePhrase:
          'Мне не важно, будет ли достигнута "{{goal.title}}". Мне нужна только связь с Творцом. И я здесь только для того, чтобы соединиться с Ним через эту цель.',
      },
      {
        id: 'step4',
        title: 'Шаг 4: Выявление установки',
        instruction:
          'Какая мысль или чувство возникает, когда ты думаешь о цели? Это и есть твоя установка.',
        type: 'input',
        inputField: 'userBelief',
      },
      {
        id: 'step5',
        title: 'Шаг 5: Оценка',
  ...
  },
  {
    ...
    startScreenContent: {
      title: 'Подъем МАН с целью',
      description:
        'Эта практика предназначена для работы с целью через подъем МАН (женских вод) – просьбы к Творцу о наполнении.',
    },
    steps: [
      {
        id: 'step1',
      ...
      },
      {
        ...
        instruction: 'Цель: "{{goal.title}}".',
        type: 'instruction',
      },
      {
        id: 'step3',
        title: 'Шаг 3: Локализация чувств',
        instruction: 'Представьте, что вы достигли цели. Найди, где это чувство ощущается.',
        type: 'instruction',
      },
      {
        id: 'step4',
        ...
        type: 'instruction',
        repeatablePhrase:
          'Мне не важно, будет ли достигнута "{{goal.title}}". Мне нужна только связь с Творцом.',
      },
      {
        id: 'step5',
        title: 'Шаг 5: Найдите других',
        instruction: 'Повторяй:',
        type: 'instruction',
        repeatablePhrase:
          'Все души в общей системе, которые страдают от недостижения этой цели, отпечатаны во мне.',
      },
      {
        id: 'step6',
        ...
        type: 'instruction',
        repeatablePhrase:
          'Творец, исправь их сосуд и заполни их светом. Дай "{{goal.title}}" им, а не мне.',
      },
      {
        id: 'step7',
    ...
    steps: [
      {
        id: 'step1',
        title: 'Шаг 1: Формулировка',
        instruction: 'Моя цель: "{{goal.title}}".',
        type: 'instruction',
      },
      {
        id: 'step2',
        title: 'Шаг 2: Ощущение Творца',
        instruction: 'Почувствуй Творца как свойство отдачи и любви.',
        type: 'instruction',
      },
      {
        id: 'step3',
        title: 'Шаг 3: Сравнение',
        instruction: 'Сравни ощущение от цели с ощущением от Творца. Есть ли между ними сходство?',
        type: 'instruction',
      },
      {
        id: 'step4',
        title: 'Шаг 4: Просьба о сонастройке',
        instruction: 'Повторяй:',
        type: 'instruction',
        repeatablePhrase:
          'Творец, сонастрой мою цель с Тобой. Покажи мне, как через эту цель я могу прийти к большему подобию Тебе.',
      },
      {
        id: 'step5',
        title: 'Шаг 5: Оценка',
...
export class PracticeEngineService {
  ...
  previousStep(): void {
    ...
    if (prevIndex >= -1) {
      // -1 для возврата на стартовый экран
    ...
    if (index >= 0 && index < this.currentPractice.steps.length) {
      ...
      if (this.goal) {
        ...
        if (step.repeatablePhrase) {
          step.repeatablePhrase = step.repeatablePhrase.replace(
            /\{\{goal.title\}\}/g,
            this.goal.title
          );
        }
