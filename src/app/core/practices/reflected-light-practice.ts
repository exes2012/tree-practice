...
export const reflectedLightPracticeConfig: PracticeConfig = {
  ...
  description: 'Глубокая каббалистическая практика работы с отраженным светом, создания Малхут в Творце и достижения взаимного получения ради отдачи.',
  
  hasStartScreen: true,
  startScreenContent: {
    title: 'Работа в отраженном свете',
    description: 'Это продвинутая каббалистическая практика, которая учит работать с отраженным светом, создавать Малхут в Творце и достигать состояния взаимного получения ради отдачи.',
    duration: '30-40 мин',
    level: 'Продвинутый'
  },
