...
export const goalManPracticeConfig: PracticeConfig = {
  ...
  description: 'Практика подъема МАН через работу с целью, включение других участников и исправление намерений.',
  
  hasStartScreen: true,
  startScreenContent: {
    title: 'Подъем МАН с целью',
    description: 'Практика поможет поработать с целью через каббалистический подход: самоотмена, включение других душ и подъем общего МАН.',
    duration: '25-30 мин',
    level: 'Продвинутый'
  },
